...
/*
 */
class SocialButtons : public juce::Component, public juce::Button::Listener
{
public:
    SocialButtons()
    {
        ...
        b->addListener (this);
        auto ffLogo = juce::ImageCache::getFromMemory (
            FFAudioData::LogoFF_png, FFAudioData::LogoFF_pngSize);
        b->setImages (false,
                      true,
                      true,
                      ffLogo,
        ...
        b->setTooltip (TRANS (
            "Go to the Foley's Finest Audio Website \"foleysfinest.com\""));
        addAndMakeVisible (b);

        b = buttons.add (new juce::ImageButton());
        b->addListener (this);
        auto fbLogo = juce::ImageCache::getFromMemory (
        ...
        b = buttons.add (new juce::ImageButton());
        b->addListener (this);
        auto inLogo = juce::ImageCache::getFromMemory (
            FFAudioData::Inlogo_png, FFAudioData::Inlogo_pngSize);
        b->setImages (false,
                      true,
                      true,
                      inLogo,
        ...
        b = buttons.add (new juce::ImageButton());
        b->addListener (this);
        auto githubLogo = juce::ImageCache::getFromMemory (
            FFAudioData::GitHublogo_png, FFAudioData::GitHublogo_pngSize);
        b->setImages (false,
                      true,
                      true,
                      githubLogo,
    ...
    {
        auto renderedText = juce::ImageCache::getFromMemory (
            FFAudioData::FFtext_png, FFAudioData::FFtext_pngSize);
        g.drawImageWithin (
            renderedText,
            0,
            0,
    ...
    void resized() override
    {
        ...
        for (auto* b : buttons)
            b->setBounds (
                bounds.removeFromLeft (bounds.getHeight()).reduced (3));
    }
